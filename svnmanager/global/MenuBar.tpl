<table class="menu">
    ...
    <tr><td><com:TLinkButton ID="GroupEditButton" Text="Group Admin" CausesValidation="false" OnClick="onClickGroupEditBtn" class="menu" Visible="#!$this->User->isAdmin()&&!$this->User->isConfigAdmin()" /></td></tr>
